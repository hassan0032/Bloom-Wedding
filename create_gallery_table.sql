...
DO $$ 
BEGIN
    IF NOT EXISTS (SELECT FROM information_schema.tables WHERE table_schema = 'public' AND table_name = 'gallery_images') THEN
        ...
        RAISE NOTICE 'gallery_images table created successfully';
    ELSE
        RAISE NOTICE 'gallery_images table already exists';
    END IF;
END $$;
